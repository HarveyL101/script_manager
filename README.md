...
> [!NOTE]
> This project and the subsequent scripts are focused purely on linux based systems, and makes no attempt to function on Windows systems. Therefore it would be advisable not to be use this on Windows systems.
